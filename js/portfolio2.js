/* Ã¢â Rs.Ã¢â Rs. portfolio.js  -  Portfolio Consolidation Module Ã¢â Rs.Ã¢â Rs. */
'use strict';

const Portfolio = (() => {

  /* Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.Ã¢â Rs.
  ...
  const exportConsolidatedExcel = async (portfolio) => {
    ...
    // Ã¢â Rs.Ã¢â Rs. Color palette Ã¢â Rs.Ã¢â Rs.
    ...
    /* Ã¢â Rs.Ã¢â Rs. SHEET 1: Portfolio Summary Ã¢â Rs.Ã¢â Rs. */
    ...
    /* Ã¢â Rs.Ã¢â Rs. SHEET 2: Consolidated FY Summary Ã¢â Rs.Ã¢â Rs. */
    ...
    /* Ã¢â Rs.Ã¢â Rs. SHEET 3: Consolidated Journal Entries Ã¢â Rs.Ã¢â Rs. */
    ...
    /* SHEET: Consolidated JE â€” FY-first layout (all entry types together per year) */
    ...
    /* â”€â”€ FY-FIRST: for each FY, show all entry types together â”€â”€ */
    allFYs2.forEach(fy => {
      ...
      // â”€â”€ FY Banner (dark header spanning all 5 columns) â”€â”€
      ...
      // â”€â”€ Loop through each entry type within this FY â”€â”€
      JE_TYPES2.forEach(jeType => {
        ...
        // Dr rows (light blue) â€” one per lease, skip zero
        ...
        // Cr rows (light yellow) â€” one per lease, skip zero
        portfolio.forEach((l, li) => {
      ...
      // â”€â”€ FY Grand Total (all entry types combined for this FY) â”€â”€
...
/* Ã¢â Rs.Ã¢â Rs. Write and download Ã¢â Rs.Ã¢â Rs. */
    const buf  = await wb.xlsx.writeBuffer();
    const blob = new Blob([buf], { type: 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet' });
    saveAs(blob, `ConsolidatedPortfolio_${_today()}.xlsx`);
  };

  /* Ã¢â Rs.Ã¢â Rs. Helper Ã¢â Rs.Ã¢â Rs. */
  const _today = () => {
    const d = new Date();
